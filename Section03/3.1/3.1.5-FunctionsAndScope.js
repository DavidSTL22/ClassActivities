...
// ? what do you expect ?
//console.log(total); Total is undefined because it is inside of the function scope.
...
function parentAndChildScope() {
  ...
  console.log("Parent Scope, Child Variable:", childVariable); //This won't print because it is defined inside of the above function.
}
